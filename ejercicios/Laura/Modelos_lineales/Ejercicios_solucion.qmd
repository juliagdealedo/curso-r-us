...
Tenemos un dataset con riqueza de especies en las islas Galápagos. Nos preguntamos si hay un efecto de la variable área de la isla, elevación máxima de la isla y distancia a la isla más próxima en la riqueza de especies.
...
ggcorr(gala[,c(1,3:6)], label = TRUE)
```
[Parece relación estre riqueza especies y área y elevación. Convertir a log podría ayudar.]{style="font-size:20px"}

[Relación entre área y elevación. ¿Qué se podría hacer? Quitar una.]{style="font-size:20px"}
...
[Sigue sin ser lineal la relación.]{style="font-size:25px"}
...
```{r}
#| echo: true
cobertura$sequia <- as.factor(cobertura$sequia)
