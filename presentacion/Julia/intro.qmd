...
![Ejemplo quarto](images/quarto.png){width="600px" height="550px" fig-align="left"}
...
## Distribución normal
Peso de personas → muchas alrededor del promedio (forma de campana) NORMAL 
```{r}
#| echo: true
#| attr-source: "style='font-size: 0.5em'"
#| attr-output: "style='font-size: 0.3em'"
...
5. Crea un vector con 10 temperaturas y usa ifelse() para clasificar cada valor como "Frío" o "Caluroso", segun lo que tu consideres
...
# Crea una tabla con esta clasificación 
