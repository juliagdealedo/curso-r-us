...
## Ejercicios
 ...
 3. Ejercicio\
  ...
  4. Crea un vector con edades y usa una comparación para saber cuáles son mayores de edad y cualcula cuantos no lo son
...
Se usa cuando quieres hacer lo mismo para muchos elementos (por ejemplo, recorrer filas, listas o vectores).\
...
![🙏 cómo organizar tus carpetas🙏 ](images/folders.png){width="200px" height="300px" fig-align="left"}

En la práctica, los datos vienen en archivos externos: CSV, Excel, TXT, u online. \
El formato .csv (comma separated values) es el más común.
Cada columna está separada por una coma o punto y coma.
...
::: {.column width="50%"}
![🙏 cómo organizar tus carpetas🙏 ](images/folders.png)
:::
:::::
