...
[Relación lineal entre dos o más variables, dependiendo una (variable dependiente) de la(s) otra(s) (variable(s) explicativa(s))]{style="font-size:30px"}

[Variable dependiente: *y*]{style="font-size:30px"}

[Variable(s) explicativa(s): *x*]{style="font-size:30px"}

[Modelo matemático lineal: *y = 2x* o *y = 3 - 2x*]{style="font-size:30px"}
...
![Visualización modelo lineal](F:/Nextcloud13102025/CursoR/Github/curso-r-us/presentacion/Laura/Modelos_lineales/Residuos.jpg){width="600px" height="550px" fig-align="left"}

***

![Normalidad y homocedasticidad en los residuos](F:/Nextcloud13102025/CursoR/Github/curso-r-us/presentacion/Laura/Modelos_lineales/Normalidad.jpg){width="500px" height="400px" fig-align="left"}
...
[Supuestos de linealidad, normalidad y homocedasticidad]{style="font-size:30px"}
...
[Supuestos linealidad, normalidad, homocedasticidad]{style="font-size:18px"}

![Residuos frente a valores predichos](F:/Nextcloud13102025/CursoR/Github/curso-r-us/presentacion/Laura/Modelos_lineales/supuestos1.png){width="425px" height="200px" fig-align="left"}

[Supuesto normalidad]{style="font-size:18px"}

![Gráfico Q-Q](F:/Nextcloud13102025/CursoR/Github/curso-r-us/presentacion/Laura/Modelos_lineales/supuestos2.png){width="425px" height="200px" fig-align="left"}

***

[Supuesto homocedasticidad]{style="font-size:18px"}

![Gráfico dispersión varianza residual](F:/Nextcloud13102025/CursoR/Github/curso-r-us/presentacion/Laura/Modelos_lineales/supuestos3.png){width="425px" height="200px" fig-align="left"}


[Datos sobreinfluyentes en el análisis]{style="font-size:18px"}

![Valores distancia de Cook](F:/Nextcloud13102025/CursoR/Github/curso-r-us/presentacion/Laura/Modelos_lineales/supuestos4.png){width="425px" height="200px" fig-align="left"}
...
ncvTest(lm_reg1)
```
[Si no se cumplen supuestos del modelo: transformación variables (logarítmica, raíz cuadrada, Box-Cox, log-log, etc.)]{style="font-size:22px"}
...
[Suma de cuadrados tipo I o III]{style="font-size:20px"}
...
[Suma de cuadrados tipo I: anova()]{style="font-size:20px"}

[Suma de cuadrados tipo III: Anova(lm,type="III")(library(car))]{style="font-size:20px"}
...
Pregunta: Diferencias longitud aleta tres especies de pingüino

***

Hipótesis

*H~0~* (hipótesis nula): no existe diferencias en las medias de la longitud de la aleta para las tres especies
...
[Ecuación: *y~i~* = 186.95 + 5.86*Chinstrap* + 27.23*Gentoo*]{style="font-size:20px"}
...
[*y~i~ = -6787.3 + 4251.4 Adelie + 3750.1 Chinstrap + (54.6 - 21.8 Adelie -20.0) flipper_length*]{style="font-size:25px"}
